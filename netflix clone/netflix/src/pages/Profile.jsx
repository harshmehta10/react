  ...
  return (
    <>
      <div>
        <div>
          <img
            className="block w-full h-[750px] object-cover"
          ...
          <div className="bg-black/60 fixed top-0 left-0 w-full h-[750px]" />
        ...
        <div className="relative flex items-center group">
          ...
          >
            {movies.map((movie) => (
              <div
                key={movie.id}
                className="relative w-[160px] sm:w-[200px] lg:w[280px] inline-block rounded-lg overflow-hidden cursor-pointer m-2"
              >
                <img
